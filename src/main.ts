    ...
    const init = () => {
        ...
        const routes = {
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 justify-items-center">
                ...
                ${Developer('/dhom.png', 'Dhominick John Billena', 'Backend Developer', "I believe and sincerely believe that being in the backend is one of the happiest thing I can do!", "", "https://github.com/DhominickJ", "")}
                </div>
                <div class="col-span-1">
