        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#" class="text-yellow-900 hover:text-red-600 px-3 py-2 text-sm font-medium">Home</a>
                    <a href="#" class="text-yellow-900 hover:text-red-600 px-3 py-2 text-sm font-medium">How it works</a>
                    <a href="#" class="text-yellow-900 hover:text-red-600 px-3 py-2 text-sm font-medium">Listings</a>
                    <a href="#" class="text-yellow-900 hover:text-red-600 px-3 py-2 text-sm font-medium">About</a>
                </div>
